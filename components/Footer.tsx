...
const YOUTUBE_URL = 'https://www.youtube.com/@snkwebsolution';
    ...
    <footer className="bg-[#0D0D0D] border-t border-[#2A2A2A] text-sm text-white overflow-hidden">
          ...
          <StaggerItem variant="fadeUp">
            <div>
              ...
              <p className="text-[#888888] text-sm leading-relaxed mb-6 max-w-[240px]">
                ...
                trusted partner for websites, digital marketing, and branding.
              </p>
      ...
      >
        <div className="text-[#555555] text-xs tracking-wide">
          © {FOUNDED_YEAR}–Present <span className="text-[#888888]">SNK</span>. All Rights Reserved.
        </div>
        <div className="flex items-center gap-5 text-xs text-[#555555]">
          <Link href="/privacy-policy" className="hover:text-[#E31E24] transition-colors">
            Privacy Policy
          </Link>
          <span className="text-[#2A2A2A]">|</span>
          <Link href="/terms" className="hover:text-[#E31E24] transition-colors">
            Terms &amp; Conditions
          </Link>
        </div>
      </Reveal>
