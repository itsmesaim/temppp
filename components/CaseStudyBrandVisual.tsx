...
export default function CaseStudyBrandVisual({
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(ellipse at 30% 20%, ${accent}18 0%, transparent 55%), linear-gradient(145deg, #1A1A1A 0%, #111111 50%, #0D0D0D 100%)`,
      }}
    >
      <div
      ...
      />
      <div className="absolute top-0 right-0 w-48 h-48 rounded-full blur-3xl opacity-20" style={{ background: accent }} />
      <div className="absolute bottom-0 left-0 w-36 h-36 rounded-full blur-2xl opacity-10" style={{ background: accent }} />
