            ...
            <HeroReveal>
              ...
              <HeroItem delay={0.32}>
                <div className="mt-10 flex items-center gap-8 text-sm text-[#888888]">
                  ...
                  <div>
                    <span className="text-[#E31E24] font-semibold">1500+</span> projects delivered
                  </div>
                </div>
              </HeroItem>
            </HeroReveal>
      ...
      <section className="py-8 border-b border-[#2A2A2A] bg-[#1A1A1A] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="marquee" style={{ '--marquee-duration': '42s' } as React.CSSProperties}>
            <div className="marquee-inner flex items-center gap-x-12 md:gap-x-16 py-2">
              {[...clientLogos, ...clientLogos].map((logo, index) => (
                <div
                  key={index}
                  className="h-14 md:h-[4.25rem] w-[130px] md:w-[160px] flex-shrink-0 flex items-center justify-center opacity-85 hover:opacity-100 hover:scale-105 transition-all duration-300"
                >
                  <Image
                    src={logo.src}
                    alt={logo.alt}
