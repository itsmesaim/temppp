...
export default function Home() {
  return (
    <div className="overflow-x-clip">
      ...
      <section className="relative min-h-[100dvh] flex items-center border-b border-[#2A2A2A] pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7 pt-10 pb-16 md:pb-10">
            <HeroReveal>
              <HeroItem>
                <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-[#161616] text-xs tracking-[2px] mb-6 border border-[#2A2A2A] text-[#888888]">
                  EST. 2007 • NAVI MUMBAI • MAHARASHTRA
                </div>
              </HeroItem>

              <HeroItem delay={0.08}>
                <h1 className="text-6xl md:text-7xl font-semibold tracking-tighter leading-[0.92] mb-6 text-white">
                  We turn<br />brands into<br />
                  <motion.span
              ...
              <HeroItem delay={0.16}>
                <p className="max-w-lg text-xl text-[#888888] mb-10">
                  We help businesses in Navi Mumbai, Mumbai &amp; beyond grow faster online — through smart SEO, high-converting campaigns, and AI-powered strategies that bring real results, not just reports.
                </p>
              </HeroItem>
              ...
              <HeroItem delay={0.24}>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <GlowButton>
                    <Link
                      href="/contact"
                      className="inline-flex h-14 items-center justify-center rounded-full border border-[#2A2A2A] px-8 text-lg font-medium text-white hover:bg-[#161616] hover:border-[#E31E24]/40 transition-all"
                    >
          ...
          <Reveal variant="scaleIn" delay={0.35} duration={0.85} className="md:col-span-5">
            <FloatPulse>
              <div className="relative h-[280px] sm:h-[360px] md:h-[520px] rounded-3xl overflow-hidden border border-[#2A2A2A] bg-[#161616] shadow-[0_0_60px_-15px_rgba(227,30,36,0.25)]">
                <EcosystemCanvas />
      ...
      <section className="py-8 border-b border-[#2A2A2A] bg-[#161616] overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <Stagger className="grid md:grid-cols-2 lg:grid-cols-3 gap-4" stagger={0.08}>
          {services.map((service, i) => (
            <StaggerItem key={i}>
              <HoverLift>
                <div className="group h-full p-8 rounded-3xl bg-[#161616] border border-[#2A2A2A] hover:border-[#E31E24] transition-colors duration-300">
                  <motion.div
            ...
            {[
              ...
              <StaggerItem key={i} variant="scaleIn">
                <HoverLift scale={1.04}>
                  <div className="p-8 rounded-3xl bg-[#161616] border border-[#2A2A2A] hover:border-[#E31E24]/40 transition-colors">
                    <motion.div
