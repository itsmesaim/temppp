      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-b border-[#2A2A2A]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {capabilities.map((cap) => (
            <div key={cap.title} className="p-8 rounded-3xl bg-[#161616] border border-[#2A2A2A] hover:border-[#E31E24]/50 transition-all group">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {process.map((p, i) => (
            <div key={p.step} className="relative">
              ...
              <div className="relative z-10 p-7 rounded-3xl bg-[#161616] border border-[#2A2A2A] h-full">
