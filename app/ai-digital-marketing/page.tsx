    ...
    <div className="bg-[#0D0D0D] min-h-screen overflow-x-clip">
        ...
        <Reveal className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={col.label} className={`p-6 rounded-2xl border ${col.isRed ? 'bg-[#1A0505] border-[#E31E24]/40' : 'bg-[#161616] border-[#2A2A2A]'}`}>
        ...
        <Stagger className="grid md:grid-cols-2 lg:grid-cols-3 gap-5" stagger={0.07}>
          {capabilities.map((cap) => (
            <StaggerItem key={cap.title}>
              <HoverLift>
              <div className="p-8 rounded-3xl bg-[#161616] border border-[#2A2A2A] hover:border-[#E31E24]/50 transition-colors duration-300 group h-full">
        ...
        <Stagger className="grid md:grid-cols-4 gap-6" stagger={0.1}>
          {process.map((p, i) => (
            ...
            <div className="relative h-full">
              ...
              <HoverLift>
              <div className="relative z-10 p-7 rounded-3xl bg-[#161616] border border-[#2A2A2A] h-full hover:border-[#E31E24]/40 transition-colors">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 border-b border-[#2A2A2A]">
        ...
        <Stagger className="space-y-4" stagger={0.06}>
          {faqs.map((faq, i) => (
            <StaggerItem key={i}>
            <div className="p-7 rounded-2xl bg-[#161616] border border-[#2A2A2A] hover:border-[#E31E24]/30 transition-colors">
