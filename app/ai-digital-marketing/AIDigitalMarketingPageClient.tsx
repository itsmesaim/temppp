...
const results = [
  {
    number: '3.8x',
    label: 'Average improvement in ROAS vs. manual management',
  },
...
const process = [
  {
    step: '01',
    title: 'AI Audit',
    desc: 'We analyse your existing data, campaigns, and tech stack to identify where AI can make the biggest impact immediately.',
  },
  {
    step: '02',
    title: 'Strategy & Stack',
    desc: 'We design your bespoke AI marketing architecture — selecting and integrating the right tools for your specific goals.',
  },
  {
    step: '03',
    title: 'Launch & Learn',
    desc: 'Campaigns go live with AI optimisation active from day one. The system learns fast; results improve week over week.',
  },
  {
    step: '04',
    title: 'Scale & Compound',
    desc: 'As your AI models accumulate data, performance compounds. The longer we work together, the greater the competitive advantage.',
  },
];
  ...
  return (
    <div className="bg-[#0D0D0D] min-h-screen overflow-x-clip">
            ...
            <HeroReveal>
              ...
              <HeroItem delay={0.08}>
                <h1 className="text-6xl md:text-8xl font-semibold tracking-tighter leading-[0.88] mb-6 text-white max-w-4xl">
                  AI Digital
                  <br />
                  <span className="text-[#E31E24]">Marketing agency, </span>
                </h1>
              </HeroItem>
              <HeroItem delay={0.14}>
                <p className="max-w-2xl text-xl md:text-2xl text-[#888888] mb-10 leading-relaxed">
                  ...
                  intelligence to outpace them on every channel, every day — from campaigns to
                  content to lead generation.
                </p>
              </HeroItem>
              <HeroItem delay={0.2}>
        ...
        <Reveal className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-[#888888] text-lg leading-relaxed mb-6">
              Traditional digital marketing relies on human instinct and weekly optimisations. AI
              marketing operates on machine precision and millisecond decisions — processing
              millions of data points to maximise every campaign, continuously.
            </p>
            <p className="text-[#888888] text-lg leading-relaxed">
              At SNK, we combine cutting-edge AI tools with deep human expertise. The machines
              handle the data. Our strategists handle the vision. Together, we drive results that
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div
                key={col.label}
                className={`p-6 rounded-2xl border ${col.isRed ? 'bg-[#1A0505] border-[#E31E24]/40' : 'bg-[#1A1A1A] border-[#2A2A2A]'}`}
              >
                <div
                  className={`text-xs tracking-[2px] font-semibold mb-4 ${col.isRed ? 'text-[#E31E24]' : 'text-[#555555]'}`}
                >
                  {col.label}
                </div>
                {col.items.map((item) => (
                  <div
                    key={item}
                    className={`text-sm py-2 border-b border-[#2A2A2A] last:border-0 ${col.isRed ? 'text-[#CCCCCC]' : 'text-[#555555] line-through'}`}
                  >
                    {item}
                  </div>
                ))}
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-b border-[#2A2A2A]">
        ...
        <h2 className="text-5xl font-semibold tracking-tighter text-white mb-12">
      ...
      <section className="max-w-4xl mx-auto text-center px-6 py-24">
        <Reveal variant="scaleIn">
          ...
          <h2 className="text-5xl md:text-6xl font-semibold tracking-tighter text-white mb-5">
            Ready to let AI work
            <br />
            for your brand?
          </h2>
          <p className="text-[#777777] text-xl mb-10">
            We onboard a limited number of AI marketing clients each quarter. Book your strategy
            session now to secure your spot.
          </p>
          <GlowButton>
            <Link
              href="/contact"
